    ...
    return (
        <View className="flex-1 bg-[#FFFFFF]">
            ...
            <View className="bg-[#C5DCE9]">
                <TouchableOpacity className="w-[150] h-[20] justify-center p-4" onPress={backMenu}>
            ...
            <View className="flex-1">
                ...
                <View className="flex-row items-center p-1">
                    <TouchableOpacity onPress={toggleLike}>
                        {isLike ? (
                        <Heart/>) :(<Heart className="fill-red-500"/>)
                        }           
                    </TouchableOpacity>
                    <Text>
                ...
                <View className="p-1">
                    <Text className="text-small text-black-500">{currentPost?.review}</Text>
                </View>
            </View>
