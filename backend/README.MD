...
2. Environment Setup
   ...
   JWT_SECRET=CO2+izJbGawwzWR9ojx6Xwujrgx4bFMO1vZLPek+ZYgOHKZun2OPxcQBCwQj9U0Qd4WL0aFMQVhEI+T8u5T0vw==
...
4. Recommendation Service Setup (REQUIRED)
   Navigate to recommendation-service directory (leftovers/recommendation-service):
   cd recommendation-service

   Create Python virtual environment:
   python3 -m venv venv

   If windows: py -3 -m venv venv
